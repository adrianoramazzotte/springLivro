...
import com.ramazzotte.validation.biblioteca.BibliotecaInsert;
@BibliotecaInsert
public class BibliotecaNewDTO {
	...
	public BibliotecaNewDTO(Integer id, String nome, Endereco endereco, String usucriacao, OffsetDateTime datacriacao,
