...
public class LocacaoFlat {
	...
	public LocacaoFlat(Integer id, OffsetDateTime datalocacao, OffsetDateTime datadevolucao, Integer idlivro,
			String titulo, String autor, String ano, String classificacao, Integer ideditora, String razao,
			String telefone, String usucriacao, OffsetDateTime datacriacao, String usualteracao,
			...
			String status, BigDecimal multadiaria, BigDecimal valorLivro) {
		super();
		this.id = id;
		this.datalocacao = datalocacao;
		this.datadevolucao = datadevolucao;
