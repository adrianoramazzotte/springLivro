...
import com.ramazzotte.validation.editora.EditoraInsert;
@EditoraInsert
public class EditoraNewDTO {
	private Integer id;
	...
	public EditoraNewDTO(Integer id, String razao, String telefone, String usucriacao, OffsetDateTime datacriacao,
