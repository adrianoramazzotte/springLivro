...
import com.ramazzotte.validation.genero.GeneroInsert;
@GeneroInsert
public class GeneroNewDTO {
	private Integer id;
	private String nome;
	...
	public GeneroNewDTO(Integer id, String nome, String usucriacao, OffsetDateTime datacriacao, String usualteracao,
