...
import com.ramazzotte.validation.livro.LivroInsert;
@LivroInsert
public class LivroNewDTO {
	private Integer id;
	...
	public LivroNewDTO(Integer id, String titulo, String autor, String ano, String classificacao, Editora editora,
