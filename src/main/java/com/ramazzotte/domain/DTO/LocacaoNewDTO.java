...
import com.ramazzotte.validation.locacao.LocacaoInsert;
@LocacaoInsert
public class LocacaoNewDTO {
	private Integer id;
	...
	public LocacaoNewDTO(Integer id, OffsetDateTime datalocacao, OffsetDateTime datadevolucao, Livro livro,
