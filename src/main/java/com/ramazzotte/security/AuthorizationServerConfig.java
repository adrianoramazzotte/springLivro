...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		clients
			.inMemory()
			.withClient("xx")
			.secret(passwordEncoder.encode("xxxxwwee"))
			.scopes("read", "write")
			.authorizedGrantTypes("password", "refresh_token")
			.accessTokenValiditySeconds(60*60*24)//um dia
			.refreshTokenValiditySeconds(60*60*24*7)//
			
		.and()
		
			.withClient("app_web")
			.secret(passwordEncoder.encode("123Deoliveira9%%"))
			.scopes("read", "write")
			.authorizedGrantTypes("password", "refresh_token")
			...
			.withClient("app_car")
			.secret(passwordEncoder.encode("car78999"))
			.scopes("read")
			.authorizedGrantTypes("password", "refresh_token")
     	...
     	.and()  
		.withClient("mobile")
		.secret(passwordEncoder.encode("asdasd"))
		.scopes("read")
		.authorizedGrantTypes("password", "refresh_token")
		.accessTokenValiditySeconds(1800)
		.refreshTokenValiditySeconds(3600 * 24);
	...
	public JwtAccessTokenConverter accessTokenConverter() {
		...
		accessTokenConverter.setSigningKey("dfdfdfdfdfdfdgdsht346***()_)_)*(*¨&%GTU$%I&¨%&()&()(");
